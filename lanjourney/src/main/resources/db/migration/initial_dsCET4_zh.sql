...
VALUES
    ...
    ('congratulation', 'n.祝贺(词)'),
    ('congress', 'n.大会；国会，议会'),
    ('conjunction', 'n.接合,连接(词)'),
    ('connect', 'vt.连接，连结；联系'),
    ...
    ('expect', 'vt.预料，预期；等待'),
    ('expectation', 'n.期待/望，预期'),
    ('expense', 'n.花费，消费；费用'),
    ('expensive', 'a.昂贵的，花钱多的'),
    ('experience', 'n.经验，感受；经历'),
    ('experiment', 'n.实验；试验'),
    ('experimental', 'a.实/试验的'),
    ('expert', 'n.专家 a.熟练的'),
    ('explain', 'vt.解释；为…辩解'),
    ...
    ('interior', 'a.内的；内地的 n.内部'),
    ('intermediate', 'a.中间/级的'),
    ('internal', 'a.内的；国内的'),
    ...
    ('pollution', 'n.污染'),
    ('pond', 'n.池塘'),
    ('pool', 'n.水塘，游泳池，水池; n.共用物 vt.共有'),
    ('poor', 'a.贫穷的；贫乏的'),
    ('pop', 'n.流行音乐，流行歌曲; n.砰的一声，爆破声'),
    ('popular', 'a.民众的；流行的'),
    ...
    ('premier', 'n.总理，首相'),
    ('preparation', 'n.准/预备；制备'),
    ('prepare', 'vt.&vi.准备，预备'),
    ('preposition', 'n.前置词，介词'),
    ('prescribe', 'vt.命令；处(方)'),
    ('presence', 'n.出席，到场；在'),
    ('present', 'a.现在的 n.目前; vt.赠送; 介绍; 提出; n.礼物，赠送物'),
    ('presently', 'ad.一会儿；目前'),
    ...
    ('pronunciation', 'n.发音(法)'),
    ('proof', 'n.证据；证明；校样'),
    ('proper', 'a.适合的；合乎体统的'),
    ('properly', 'ad.适当地；彻底地'),
    ('property', 'n.财产，资产；性质'),
    ('proportion', 'n.比，比率，部分'),
    ('proportional', 'a.比例/相称的'),
    ('proposal', 'n.提议，建议；求婚'),
    ('propose', 'vt.提议 vi.求婚'),
    ('prospect', 'n.展望；前景，前程'),
    ...
    ('pulse', 'n.脉搏；脉冲，脉动'),
    ('pump', 'n.泵 vt.用抽机抽'),
    ('punch', 'vt.冲出 n.冲压机; vt.用拳猛击 n.拳打'),
    ...
    ('racial', 'a.种族的，人种的'),
    ('rack', 'n.搁物架；行李架; vt.使苦痛，折磨'),
    ('racket', 'n.球拍'),
    ('radar', 'n.雷达，无线电探测器'),
    ('radiate', 'vi.发射光线；辐射'),
    ('radiation', 'n.放/发射；辐射能'),
    ('radio', 'n.无线电；收音机'),
    ('radioactive', 'a.放射性的'),
    ...
    ('resist', 'vt.&vi.抵抗，抵制'),
    ('resistance', 'n.抵抗/制；抵抗力'),
    ('resistant', 'a.抵抗的，反抗的'),
    ('resolution', 'n.坚决/定；决定'),
    ('resolve', 'vt.解决；决心 n.决心'),
    ('resort', 'vi.&n.求助，凭借'),
    ('resource', 'n.资源，物力；办法'),
    ('respect', 'n.&vt.尊敬，尊重'),
    ('respectful', 'a.恭敬的，尊重的'),
    ('respective', 'ad. 各自的，各个的'),
    ('respectively', 'ad.各自/分别地'),
    ('respond', 'vi.作答；响应'),
    ('response', 'n.作答，回答；响应'),
    ...
    ('sympathize', 'vi.同情/感，共鸣'),
    ('sympathy', 'n.同情；一致，同感'),
    ('synthetic', 'a.综合的；合成的'),
    ('system', 'n.系统，体系；制度'),
    ('systematic(al)', 'a.有系统/计划的'),
    ('table', 'n.桌子；餐桌；项目表'),
    ('tablet', 'n.碑，匾；药片'),
    ('tag', 'n.附加语；标签'),
    ('tail', 'n.尾巴；末尾部分'),
    ...
    ('tram', 'n.(有轨)电车'),
    ('tramp', 'n.流浪者，游民'),
    ('transfer', 'vt.转移；调动 vi.转移'),
    ('transform', 'vt.改变/造；变换'),
    ('transformation', 'n.变化；改造；转变'),
    ('transformer', 'n.变压/转换器'),
    ('transistor', 'n.晶体管'),
    ('translate', 'vt.翻译，译 vt.翻译'),
    ('translation', 'n.翻译；译文/本'),
    ...
    ('zoo', 'n.动物园'),
    ('chick', 'n. 小鸡; 少妇'),
    ('meant', 'v. 意味着; 打算 (mean的过去式和过去分词)'),
    ('vowel', 'n. 元音; 元音字母'),
    ('brought', 'vt. 带来; 引起 (bring的过去式和过去分词)'),
    ('were', 'v. 是 (be的过去复数式)'),
    ('toward', 'prep. 向; 对于; 接近'),
    ('fig', 'n. 无花果; 无足轻重的事物'),
    ('quotient', 'n. [数] 商; 份额'),
    ('suffix', 'n. 后缀; 下标'),
    ('did', 'v. 做 (do的过去式)'),
    ('lost', 'a. 迷途的; 丢失的 v. 遗失 (lose的过去式)'),
    ('came', 'v. 来 (come的过去式)'),
    ('felt', 'v. 感觉 (feel的过去式) n. 毡'),
    ('began', 'v. 开始 (begin的过去式)'),
    ('sat', 'v. 坐 (sit的过去式)'),
    ('got', 'v. 得到 (get的过去式)'),
    ('does', 'v. 做 (do的第三人称单数形式)'),
    ('syllable', 'n. 音节'),
    ('are', 'v. 是 (be的第二人称单复数及第一、三人称复数)'),
    ('sent', 'v. 发送 (send的过去式和过去分词)'),
    ('spoke', 'v. 说话 (speak的过去式) n. 轮辐'),
    ('heard', 'v. 听见 (hear的过去式和过去分词)'),
    ('knew', 'v. 知道; 认识 (know的过去式)'),
    ('kept', 'v. 保持; 遵守 (keep的过去式和过去分词)'),
    ('went', 'v. 去 (go的过去式)'),
    ('broke', 'v. 打破 (break的过去式) a. 没钱的'),
    ('don''t', 'v. 不 (do not的缩写)'),
    ...
    ('an', 'art. 一个 (用于元音音素开头的词前)'),
    ('has', 'v. 有 (have的第三人称单数)'),
    ('may', 'aux. 可能; 可以; 祝愿'),
    ('made', 'v. 制造 (make的过去式和过去分词)'),
    ('held', 'v. 持有; 握住 (hold的过去式和过去分词)'),
    ('written', 'v. 写 (write的过去分词) a. 书面的'),
    ('populate', 'vt. 居住于; 构成...的人口'),
    ('fell', 'v. 落下 (fall的过去式) vt. 砍倒'),
    ('consonant', 'n. 辅音; 辅音字母 a. 一致的'),
    ('said', 'v. 说 (say的过去式和过去分词)'),
    ('stead', 'n. 代替; 用处'),
    ('women', 'n. 女人们 (woman的复数)'),
    ('led', 'v. 领导; 通向 (lead的过去式和过去分词)'),
    ('done', 'v. 做 (do的过去分词) a. 完成的'),
    ('stood', 'v. 站立 (stand的过去式和过去分词)'),
    ('oxygen', 'n. [化] 氧气'),
    ('am', 'v. 是 (be的第一人称单数现行式)'),
    ('feet', 'n. 脚; 英尺 (foot的复数)'),
    ('favor', 'n. 好感; 喜爱 vt. 赞成; 偏好'),
    ('lone', 'a. 孤独的; 唯一的'),
    ('won''t', 'v. 将不 (will not的缩写)'),
    ('segment', 'n. 段; 部分 vt. 分割'),
    ('children', 'n. 孩子们 (child的复数)'),
    ('dad', 'n. 爸爸'),
    ('center', 'n. 中心; 核心'),
    ('neighbor', 'n. 邻居; 邻国'),
    ('was', 'v. 是 (be的过去单数式)'),
    ('gone', 'v. 去 (go的过去分词) a. 离去的; 死亡的'),
    ('caught', 'v. 抓住 (catch的过去式和过去分词)'),
    ('numeral', 'n. 数字; 数词'),
    ('grew', 'v. 生长; 增加 (grow的过去式)'),
    ('told', 'v. 告诉 (tell的过去式和过去分词)'),
    ('men', 'n. 男人们 (man的复数)'),
    ('took', 'v. 拿; 花费 (take的过去式)'),
    ('teeth', 'n. 牙齿 (tooth的复数)'),
    ('been', 'v. 是 (be的过去分词)'),
    ('equate', 'vt. 使相等; 视为等同'),
    ('is', 'v. 是 (be的第三人称单数形式)'),
    ('crease', 'n. 折痕; 皱褶'),
    ('pose', 'vt. 造成; 提出 n. 姿势'),
    ('melody', 'n. 曲调; 旋律') ON CONFLICT (LOWER(term)) DO NOTHING;